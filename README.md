...
Most portfolios stop at reporting a model's accuracy or recall. This one doesn't trust that number — it deliberately goes looking for where the [order-cancellation classifier from a previous project](../classification-baseline-to-best) breaks, and documents exactly why.
